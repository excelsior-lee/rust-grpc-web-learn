...
class ProcessStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AfterProcess = channel.unary_unary(
                '/infer.Process/AfterProcess',
                request_serializer=infer__pb2.AfterProcessRequest.SerializeToString,
                response_deserializer=infer__pb2.AfterProcessResponse.FromString,
                )
...
def add_ProcessServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AfterProcess': grpc.unary_unary_rpc_method_handler(
                    servicer.AfterProcess,
                    request_deserializer=infer__pb2.AfterProcessRequest.FromString,
                    response_serializer=infer__pb2.AfterProcessResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class Process(object):
    ...
    def AfterProcess(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/infer.Process/AfterProcess',
            infer__pb2.AfterProcessRequest.SerializeToString,
            infer__pb2.AfterProcessResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
